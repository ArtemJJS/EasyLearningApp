...
<main>
    ...
    <form id="reg_form" method="post" action="${pageContext.request.contextPath}/basic_servlet">
        ...
        <div class="param param1">
            ...
            <div class="input_and_pattern">
                <input placeholder='<fmt:message key='global.login' bundle='${rb}'/>' type="text" id="login-field"
                       name="login" required pattern="[A-Za-zА-я0-9_ -]{3,30}" maxlength="30">
        ...
        <div class="param param2">
            ...
            <div class="input_and_pattern">
                <input type="password" id="password-field" name="password" maxlength="50"
        ...
        <div class="param param3">
            ...
            <div class="input_and_pattern">
                <input type="text" id="name-field" name="name"
                       placeholder='<fmt:message key='global.name' bundle='${rb}'/>'
                       required pattern="[A-Za-zА-я]{2,30}" maxlength="30">
        ...
        <div class="param param4">
            ...
            <div class="input_and_pattern">
                <input type="text" id="surname-field" name="surname"
                       placeholder='<fmt:message key='global.surname' bundle='${rb}'/>' required
                       pattern="[A-Za-zА-я]{2,30}" maxlength="30">
