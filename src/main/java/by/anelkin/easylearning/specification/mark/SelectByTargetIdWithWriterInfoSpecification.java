...
public class SelectByTargetIdWithWriterInfoSpecification implements AppSpecification<Mark>, MarkSpecification<Mark> {
    ...
    public SelectByTargetIdWithWriterInfoSpecification(MarkType markType, int targetId) {
